        ...
        >
          ...
          >
            ...
            <div className="text-sm text-gray-400 mb-4">
              示例路径：
              <br />
              Windows: <code className="bg-gray-800 px-1 rounded">C:\Users\YourName\Documents</code>
              <br />
              Mac/Linux: <code className="bg-gray-800 px-1 rounded">/Users/YourName/Documents</code>
            </div>
